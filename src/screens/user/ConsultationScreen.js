          ...
          <View style={styles.box}>
            ...
            <List.Item
              onPress={() => {
                ...
                navigation.navigate(routes.CONSULTATION_DETAILS, {consultation:item
                })
              }}
              
              titleStyle={{color:"black", fontSize:30, fontFamily:'serif', marginBottom:2}}
                title={`Dr.${item.doctorName}`}
              descriptionStyle={{color:"black"}}
                description={<Text numberOfLines={3} style={{color:"black", fontSize:15}}>
                {item.specialization}{'\n'}{getDateTime(item.startTime).formattedDate1}</Text> }              
