...
export { default as DocumentScreen } from "./user/DocumentScreen";
export { default as ConsultationScreen } from "./user/ConsultationScreen";
export { default as DoctorListScreen } from "./doctor/DoctorsListScreen";
